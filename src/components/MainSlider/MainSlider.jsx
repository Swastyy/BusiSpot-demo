...
import car1 from '../../assets/view-5.jfif';
import car2 from '../../assets/view-4.jfif';
import car3 from '../../assets/view-3.jfif';
import car4 from '../../assets/view-2.jfif';
import car5 from '../../assets/view-1.jfif';
  ...
  return (
    <>
      <TestSlider {...settings}>
        <SliderWrapper>
          <div>
            <h2>The Best Platform for Spot Rental</h2>
            <p>
        ...
        <SliderWrapper>
          <div>
            <h2>Easy way to rent a spot at a low price</h2>
            <p>
              Providing cheap spot rental services and safe and comfortable
              facilities.
            </p>
          </div>
          <RentalCarBtn />
